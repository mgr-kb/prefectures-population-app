import type { PopulationCompositionPerYearResponse } from "@/api/population";
import type { PrefecturesResponse } from "@/api/prefectures";
import { configs } from "@/configs";
import { http, HttpResponse } from "msw";

const { baseUrl, prefectures, populationCompositionPerYear } = configs;
...
const prefecturesResponse: PrefecturesResponse = {
  message: null,
  result: [
...
function populationCompositionPerYearResponse(): PopulationCompositionPerYearResponse {
  return {
    message: null,
    result: {
      boundaryYear: 2020,
